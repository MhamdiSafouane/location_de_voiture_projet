...
<div id="select-butn-fileter-container-indiv">
  <div>
         <button onClick={()=>setSelectBtn(false)} onDoubleClick={()=>setSelectBtn(true)} id="button-of-the-filete-the-data-in-bookin-page">naw3 l karahba</button>
   ...
   <div>
         <button onClick={()=>setSelectSeating(false)} onDoubleClick={()=>setSelectSeating(true)} id="button-of-the-filete-the-data-in-bookin-page">9adech men 3abed</button>
         {selectSeating?<div id="car-type-filter-in-booking-page">
         <input type="checkbox" className='checkbox-in-filter-in-cartype' onClick={filterFunc} id="UV" /><label>6 3bed</label><br/>
         <input type="checkbox" className='checkbox-in-filter-in-cartype' onClick={filterFunc} id="XUV"/><label>9 3bed</label><br/>
         <input type="checkbox" className='checkbox-in-filter-in-cartype' onClick={filterFunc} id="All"/><label>4 3bed</label><br/>
         </div>:null}
  </div>
  <div>
        ...
        filterData.map((d, i) => {
          return <div key={i} id="card-of-the-order-page-i-make-this">
              ...
              <div id="name-container">
                    <h5 id="name" >6 aabed</h5>
                    <h5 id="milage"  >{d.perKm}RS/KM</h5>
              </div>
              <div id="booking">
                  <h6  id="fare">details</h6>
                  <Link to="/payment"> <span onClick={()=>setCarData(d)} id="book-now-of-the-car" >reservi tawa</span></Link> 
                </div>
          </div>
        })
      }
