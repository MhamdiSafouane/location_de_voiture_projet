...
export default function AdminPage() {
    ...
    <div id="admin-page-main-home">
        ...
        <h1 id="welcome-to-admin-page">Aslema {adminName}</h1>
        <div id="main-container-of-the-addmin-page">
        <div id="add-car">
            <h3 id="info">Cars</h3>
          <Link to="/add-car-details" id="btn-add-car-link"><button id="btn-add-car">Zidd karhba</button></Link> 
        </div>
      ...
      <div id="main-container">
            {
                car.map((d, i) => {
                    return<> <div key={i} id="car-container">
                        <div id="img-container">
                              ...
                              onClick={()=>{
                                if(AdminId!==d.AdminId){
                                  ...
                                  setErr("Mandekch haq tbadel details");
                                  setOk("Mrigeeeel ")
                                }
                                else{
                                    console.log(d.AdminId)
                                    setEdit(d);
                                    Navigater("/badel details lkarhba")
                                }
                                
                                }}  />
                        </div>
                        <div id="person-of-admin-page-in-my-page"> 6 3beed</div>
                        ...
                        <span id="available-date-of-sata-of-the-page"> Date Valableeee</span>
                        <span id="date-avalable-from-till-data-of-the-admin-page">
                            {d.avalableFrom.split("-").reverse().join("/").slice(0,5)}-
                            {d.availableTill.split("-")
                        .reverse().join("/").slice(0,5)}</span>
                        </div>
                 </div>
                 </>   })
             }
