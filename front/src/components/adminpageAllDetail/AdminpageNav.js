...
<div id="logo-of-the-rental-car-app">
    ...
    <span id="name-of-the-app-rental-car-app">Ekri karhabtek Men darek</span>
</div>
<button id="logout-admin-page-butn-admin" onClick={logoutFunc} >Okhreej Ala Rouhek</button>
</nav>
</>
}