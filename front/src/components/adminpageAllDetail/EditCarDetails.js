...
export default function EditCarDetails(){
 ...
 {TokenAdmin?<><AdminpageNav/>
   ...
   <h2 id="name-of-car-detail-edit"><i>Modifyyy</i></h2>
        ...
        <div id="left-side-form">
            ...
            <div className="data-form-flex input-gap-bottom" >
                <div>
                   ...
                   <div>
                    <label>Modelll</label><br/>
                        <input type="text" placeholder="Model" 
                        className="select-things" name="model" 
            ...
            <div className="data-form-flex input-gap-bottom">
                ...
                <div>
                   ...
                   <div>
                   <label>Hatttta</label><br/>
                       <input type="date" className="date-input" 
                       name="availableTill" onChange={(e)=>setEdit(
                        {...edit,availableTill:e.target.value})} value={edit.availableTill} />                    
                   </div>
                </div>

                <div className="input-gap-bottom">
                    <label>Description</label><br/>
                    <textarea id="text-area-description" placeholder="Description" 
                    name="description" onChange={(e)=>setEdit({...edit,description:e.
                    target.value})} value={edit.description}></textarea>
                </div>
          ...
          { file? <div id="imgs-add-car-container">
            ...
            <div>
                <label> Details Lkarhba</label><br/>
                <textarea className="car-detail-description" name="carDetails" placeholder="Add Car Details.."  onChange={(e)=>setEdit({...edit,carDetails:e.target.value})} 
                value={edit.carDetails}></textarea>
            </div>
            <div>
                <label>Detailsss</label><br/>
